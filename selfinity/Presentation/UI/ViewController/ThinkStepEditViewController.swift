//
//  ThinkStepEditViewController.swift
//  selfinity
//
...
protocol ThinkStepEditViewControllerDelegate: class {
    func pop(repositories: StepModel)
}

@objcMembers
class ThinkStepEditViewController: UIViewController {
    var delegate: ThinkStepEditViewControllerDelegate!
    ...
    fileprivate var presenter: ThinkStepEditPresenter?
    ...
    func inject(presenter: ThinkStepEditPresenter) {
        self.presenter = presenter
    }
    
    override func viewDidLoad() {
        ThinkStepEditViewControllerBuilder.rebuild(self)
    ...
    func tapClose() {
        ...
        guard self.repositories.smart.specificSubject != "" &&
            ...
            self.repositories.smart.timeBound != "" else {
                ...
                //TODO:　アラートだしてStepView のcellに空を含むものにバッチを付ける
                return
        }
...
extension  ThinkStepEditViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch section {
        case .subject: self.performSegue(withIdentifier: R.segue.thinkStepEditViewController.toTextField, sender: nil)
        case .verb: self.performSegue(withIdentifier: R.segue.thinkStepEditViewController.toTextField, sender: nil)
        case .measurable: self.performSegue(withIdentifier: R.segue.thinkStepEditViewController.toTextField, sender: nil)
        case .time:
            self.nextPickerMode = true
            self.performSegue(withIdentifier: R.segue.thinkStepEditViewController.toTextField, sender: nil)
        case .count: fatalError("This row is not exist")
        }
    }
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        view.detailLabel.text = self.repositories.smart.specificSubject != "" ||  self.repositories.smart.specificVerb != "" || self.repositories.smart.measurable != "" || self.repositories.smart.timeBound != "" ? R.string.localizable.toAchive() + self.repositories.smart.createJAText() : R.string.localizable.thinkStepDetail()
...
extension ThinkStepEditViewController: UIScrollViewDelegate {
...
extension ThinkStepEditViewController: ThinkStepEditPresenterInput {
    func onErrorIndex() {
    }
...
extension ThinkStepEditViewController: TextFieldViewControllerDelegate {
